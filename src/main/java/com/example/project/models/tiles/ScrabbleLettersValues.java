...
public class ScrabbleLettersValues
{
    ...
    private static final Map<Character, ScrabbleTileData> baseLetterData = Map.<Character, ScrabbleTileData>ofEntries(
    ...
    /**
     * Returns the ScrabbleTileData for a given letter
     * @param letter
     * @return
     */
    public static ScrabbleTileData getData(Character letter) {
        return baseLetterData.get(Character.toLowerCase(letter));
    }
